-- Update the constraint to allow 8-character codes (as generated by the function)
ALTER TABLE public.game_sessions 
DROP CONSTRAINT IF EXISTS valid_game_code_format;

-- Add the updated constraint for 8-character codes
ALTER TABLE public.game_sessions 
